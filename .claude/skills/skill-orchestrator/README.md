...
**Example:**
"Research innovation ecosystem in Sao Paulo and create a landscape report"
...
4. Update the QUICK-START.md quick lookup

### Adding New Workflow Patterns

When new patterns emerge from your work:

1. Document pattern in "Special Workflow Patterns" section
...
- Add clarifying example to QUICK-START.md
...
- Review QUICK-START.md for quick answers
