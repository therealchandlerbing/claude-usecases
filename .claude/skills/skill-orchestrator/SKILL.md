...
description: Universal workflow coordinator for complex multi-skill and multi-agent operations. Routes requests, manages multi-step workflows, and coordinates sequential processing across Claude skills and GitHub agents.
version: 1.0.0
