...
### [Detailed Workflow Examples](docs/EXAMPLES.md)
...
2. **See it in action** -> Review [docs/EXAMPLES.md](docs/EXAMPLES.md)
3. **Quick reference** -> Bookmark [QUICK-START.md](QUICK-START.md)
4. **Start using** -> Let orchestrator handle complex requests

### For Developers/Maintainers

1. **Read core logic** -> Study [SKILL.md](SKILL.md)
2. **Understand implementation** -> Review [docs/IMPLEMENTATION.md](docs/IMPLEMENTATION.md)
...
```
skill-orchestrator/
├── SKILL.md                    # Core orchestration logic (500+ lines)
├── README.md                   # Comprehensive documentation (500+ lines)
├── QUICK-START.md              # Quick lookup guide (350+ lines)
├── INDEX.md                    # This file - complete navigation
└── docs/
    ├── EXAMPLES.md             # Detailed workflow examples (900+ lines)
    └── IMPLEMENTATION.md       # Integration & testing guide (675+ lines)
```
...
**Quick answers:** Check [QUICK-START.md](QUICK-START.md)

**Detailed scenarios:** Review [docs/EXAMPLES.md](docs/EXAMPLES.md)

**Technical details:** Study [SKILL.md](SKILL.md)

**Implementation issues:** Consult [docs/IMPLEMENTATION.md](docs/IMPLEMENTATION.md)
