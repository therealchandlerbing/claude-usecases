...
2. **Research to report**
   - Input: "Research innovation funding in São Paulo and create a landscape report"
...
3. **Documentation updates:**
   ...
   - Update REFERENCE.md with new patterns
...
2. Add to agent list in REFERENCE.md
...
2. Add to common workflows in REFERENCE.md
